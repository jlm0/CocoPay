  ...
  ),
  {
    variants: {
      variant: {
        ...
        muted: 'font-sans text-muted-foreground text-sm',
        heading: 'text-2xl font-sans-semibold tracking-tight',
        body: 'text-base font-sans',
        caption: 'text-sm font-sans text-muted-foreground',
        display: 'text-4xl font-sans-bold tracking-tight',
        'display-medium': 'text-xl font-sans-semibold tracking-tight',
      },
    },
    defaultVariants: {
      variant: 'default',
